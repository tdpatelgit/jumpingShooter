...
class Game:
    ...
    def start_screen(self):
        ...
        while self.scene == "start":
            ...
            # Start button
            pygame.draw.rect(self.screen, (0, 255, 0), start_button)  # Green button
            start_text = font.render("Start", True, (0, 0, 0))
            start_text_rect = start_text.get_rect(center=start_button.center)
            self.screen.blit(start_text, start_text_rect)

            # Quit button
            pygame.draw.rect(self.screen, (255, 0, 0), quit_button)  # Red button
    ...
    def pause_menu(self):
        ...
        pygame.draw.rect(self.screen, (255, 255, 255), resume_button)
        ...
        pygame.draw.rect(self.screen, (0, 255, 0), menu_button)  # Green button
